...
from app.api.v1 import (
    # analytics,  # TEMP: Disabled due to Pydantic schema issues
    auth,
    bills,
    # compare,  # TEMP: Disabled due to Pydantic schema issues
    politicians,
    presidents,
    promises,
    search,
...
# api_router.include_router(analytics.router, prefix="/v1", tags=["analytics"])  # TEMP
# api_router.include_router(compare.router, prefix="/v1", tags=["compare"])  # TEMP
