...
import { getCategory, getCategoryColorClass, CATEGORIES } from "@/lib/categories";
...
export function EntityDetailShell({
  ...
  const categoryColor = category ? getCategoryColorClass(category.color, "bg") : "bg-gray-100 dark:bg-gray-800";
  ...
  const breadcrumbItems = [
    { label: "Home", href: "/" },
    { label: categoryNavLabel, href: categorySlug ? `/search?type=${categorySearchType || categorySlug}` : undefined },
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Header */}
      <div className={`rounded-xl p-6 sm:p-8 ${categoryColor} bg-opacity-20 dark:bg-opacity-10 border border-gray-200 dark:border-gray-800`}>
