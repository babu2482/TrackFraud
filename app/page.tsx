          ...
          {stats && (
            <div className="flex justify-center mb-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 text-green-400 text-sm">
                ...
                Live Data · {formatNumber(stats.canonicalEntities)} entities tracked
              </div>
            </div>
          )}
          ...
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 text-center">
              <div className="p-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Charities</p>
              </div>
              <div className="p-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm">
                <p className="text-xl font-bold text-gray-900 dark:text-white">
                  {formatNumber(stats.corporateProfiles)}
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Companies</p>
              </div>
              <div className="p-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm">
                <p className="text-xl font-bold text-gray-900 dark:text-white">
                  {formatNumber(stats.corporateFilings)}
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">SEC Filings</p>
              </div>
              <div className="p-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm">
                <p className="text-xl font-bold text-gray-900 dark:text-white">
              ...
              <div className="p-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Data Sources</p>
              </div>
              <div className="p-3 rounded-xl bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm">
                <p className="text-xl font-bold text-gray-900 dark:text-white">
                  {stats.ingestionRuns}
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Syncs</p>
              </div>
            </div>
          </div>
        </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-gray-500 dark:text-gray-400 max-w-xl mx-auto">
            Dive into specific areas of financial transparency and accountability.
          </p>
        </div>
      ...
      <section className="border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-gray-400 dark:text-gray-500">
            {["IRS", "SEC", "FEC", "CFPB", "CMS", "OFAC", "EPA", "FDA", "HHS", "SAM.gov", "Congress.gov", "USASpending.gov"].map(
              (source) => (
                <span key={source} className="hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                  {source}
                </span>
              )
            )}
